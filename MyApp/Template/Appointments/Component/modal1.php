        ...
        <form method="post" id="submit-modal1">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="dateApp" id="dateApp1" value="<?= $arrayDateAdd['day1']; ?>">
                    <select class="form-select" id="durationApp1" name="durationApp">
                    ...
                    <input type="hidden" name="durationStatus" id="durationStatus1" value="0">
                    <input type="hidden" name="user_id" id="user_id1" value="<?= $_SESSION['user_id']; ?>">
                </div>
