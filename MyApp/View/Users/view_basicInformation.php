            ...
            <div class="row g-3">
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        <div class="card-header card-header-basicinfo">
                            ...
                            </svg> ชื่อศูนย์บริการโลหิต
                        </div>
                        <div class="card-body">
                            <p class="card-text" id="nameSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="addressSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="officeHoursSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="provinceSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="districtSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="subDistrictSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" name="roadSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="postCodeSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="emailSc"></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="card shadow-sm rounded">
                        ...
                        <div class="card-body">
                            <p class="card-text" id="phoneNumberSc"></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    response.forEach(function(data) {
                        $('#nameSc').html(data.nameSc);
                        $('#addressSc').html(data.addressSc);
                        $('#officeHoursSc').html(data.officeHoursSc);
                        $('#provinceSc').html(data.provinceSc);
                        $('#districtSc').html(data.districtSc);
                        $('#subDistrictSc').html(data.subDistrictSc);
                        $('#roadSc').html(data.roadSc);
                        $('#postCodeSc').html(data.postCodeSc);
                        $('#emailSc').html(data.emailSc);
                        $('#phoneNumberSc').html(data.phoneNumberSc);
                    });
                }
            });
        })();
