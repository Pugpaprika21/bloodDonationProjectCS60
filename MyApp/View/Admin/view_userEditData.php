        ...
        <div class="card-body">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">เเก้ไขข้อมูลสมาชิก</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <form id="form-edit-user">
                <div class="row g-3">
                    ...
                    <div class="row g-3">
                        ...
                        <button type="submit" class="btn btn-warning btn-sm">เเก้ไข</button>
    ...
    $(document).ready(function() {
        ...
        $('#form-edit-user').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "../../../../bloodDonationProjectCS60/MyApp/Web/Admin/web_AdminController_editUserByID.php",
                data: Fd,
                cache: false,
                contentType: false,
                processData: false,
